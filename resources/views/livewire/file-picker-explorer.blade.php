...
>
    <div class="ufm-picker-explorer__toolbar">
        ...
        <div class="ufm-picker-explorer__toolbar-actions">
            ...
            <button type="button" class="ufm-picker-explorer__upload-button" x-on:click="uploadModal = true">
